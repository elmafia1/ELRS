...
@Client.on_message(
    ...
    commandpro ([ "/ play" ، ".play" ، "شغل" ، "تشغيل" ، "@" ])& filters.group
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        thumb_name = "https://telegra.ph/file/e270ca38db21a863a70db.jpg"
        ...
        try:
            ...
            durl  =  durl . استبدل ( "youtube" ، "youtubepp" )secmul, dur, dur_arr = 1, 0, duration.split(":")
        ...
        لوحة المفاتيح  =  InlineKeyboardMarkup ([
